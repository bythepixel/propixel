-- CreateTable
CREATE TABLE "BlockVisualTemplate" (
...
INSERT INTO "new_ContentBlock" ("body", "categoryId", "createdAt", "id", "sensitive", "title", "updatedAt", "usageGuidance") SELECT "body", "categoryId", "createdAt", "id", "sensitive", "title", "updatedAt", "usageGuidance" FROM "ContentBlock";
